...
export const seedCourts = (): Court[] => [
  { id: "C-01", name: "Court 1 — Centre", surface: "Indoor", hourlyRate: 3500, status: "active" },
  { id: "C-02", name: "Court 2 — Glass", surface: "Indoor", hourlyRate: 3200, status: "active" },
  { id: "C-03", name: "Court 3 — Terrace", surface: "Outdoor", hourlyRate: 2800, status: "active" },
  { id: "C-04", name: "Court 4 — Garden", surface: "Outdoor", hourlyRate: 2800, status: "active" },
];
